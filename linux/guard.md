...
```shell
1.王道java40SE高级阶段：
https://gitee.com/uncleTao/java40th.git

2.clash订阅链接：
https://newsubscribe.hlasw.com/api/v1/client/subscribe?token=c0c474d5e4e16b0b83c46aea4964b33e
```
...
UUID=E188ED49E7D044CE   /FileD ntfs-3g  defaults    0   1
```
